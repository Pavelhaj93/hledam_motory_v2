    ...
    <>
      ...
      <div>
        {!isPresentation ? (
          ...
          <button
            className="cursor-pointer inline-flex rounded-full gap-2 items-center bg-white text-brand hover:bg-red focus:bg-red py-3 px-6 transition-colors duration-200"
