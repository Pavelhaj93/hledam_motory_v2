    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="bg-white p-8 rounded-lg shadow-lg max-w-4xl w-full">
        ...
        <p className="mb-6 text-gray-700">
          ...
          informace o koncových uživatelích, včetně jedinečných identifikátorů, cookies, IP adres a
          e-mailů umožňujících osobní identifikaci získané na těchto stránkách a na stránkách
        ...
        <p className="mb-6 text-gray-700">
          ...
          nabídky, které vás skutečně zajímají. Svým souhlasem nám napomáháte financovat a zlepšovat
          naše služby, které tak můžeme nabízet zdarma. Kliknutím na tlačítko „souhlasím“,
          potvrzujete svůj souhlas k přístupu a zpracování výše uvedených osobních údajů a jejich
          možným sdílením s našimi vybranými partnery (včetně analytických nástrojů) pro tyto účely
          (typy zpracování):
        </p>
        ...
        <p className="mb-6 text-gray-700">
          Právní titul zpracování dat vybranými partnery najdete pro jednotlivé účely pod tlačítkem
          „Další volby“. Partneři, kteří nejsou součástí TCF 2.0, mají definované účely dle svých
          zásad zpracování.
        </p>
        ...
        <p className="mb-6 text-gray-700">
          ...
          tlačítko „Další volby“, kde najdete rovněž informace k oprávněným zájmům a možnosti proti
          nim namítat, případně svůj souhlas zcela či částečně odvolat. V případě, že svým
