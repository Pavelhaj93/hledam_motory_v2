  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <CategoryHero
        ...
        description="Objevte náš rozsáhlý katalog profesionálně repasovaných turbodmychadel s novou ložiskami a těsněními. Plná záruka kvality a spolehlivosti."
        breadcrumbs={[
          {label: 'Domů', href: '/'},
          {label: 'Katalog', href: '/katalog'},
          {label: 'Turbodmychadla'},
        ]}
      />
        ...
        <div className="mt-16 bg-gray-50 rounded-lg p-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Všechny rotory jsou profesionálně vyváženy na specializovaných strojích pro
                zajištění hladkého a tichého chodu turbodmychadla.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-3">Záruka kvality</h3>
              <p className="text-gray-600">
                Na všechna repasovaná turbodmychadla poskytujeme záruku. Každé turbodmychadlo je
                před expedicí důkladně otestováno.
              </p>
            </div>
          </div>
          ...
          <div className="mt-8 border-t pt-8">
            ...
            <div className="grid md:grid-cols-4 gap-4">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">
                  Vyvážení, testování výkonu a kontrola kvality
                </p>
              </div>
            </div>
          </div>
