...
export default async function TransmissionsPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {/* Page Header */}
      <div className="mb-12">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">Repasované převodovky</h1>
      ...
      <div className="mt-16 bg-gray-50 rounded-lg p-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-600">
              Kompletní renovace manuálních převodovek s výměnou synchronizátorů, ložisek a těsnění.
              Každá převodovka je důkladně otestována na přesnost řazení.
            </p>
          </div>
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-3">Automatické převodovky</h3>
            <p className="text-gray-600">
              Specializujeme se na renovaci automatických převodovek včetně výměny spojek, filtrů a
              kompletní výměny hydraulického systému.
            </p>
          </div>
          <div>
        ...
        <div className="mt-8 border-t pt-8">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Typy repasovaných převodovek</h3>
