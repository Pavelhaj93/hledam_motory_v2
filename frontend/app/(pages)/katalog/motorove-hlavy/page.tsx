  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <nav className="text-sm text-gray-600 mb-6">
        ...
        <span className="mx-2">/</span>
        <span>Motorové hlavy</span>
      </nav>

      {/* Page Header */}
      <div className="mb-12">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">Repasované motorové hlavy</h1>
        <div className="text-lg text-gray-600 max-w-4xl">
          <p className="mb-4">
            ...
            vozidel. Každá motorová hlava prochází kompletní renovací včetně broušení sedel ventilů,
            výměny vodítek a instalace nových těsnění. Poskytujeme{' '}
            <strong>plnou záruku kvality</strong>.
          </p>
          <p>
            Specializujeme se na renovaci motorových hlav BMW, Audi, Volkswagen, Mercedes-Benz, Ford
            a dalších značek. Používáme pouze originální nebo kvalitní alternativní díly pro
