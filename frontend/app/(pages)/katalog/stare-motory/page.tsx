...
export default async function UsedEnginesPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <CategoryHero
        title="Staré motory"
        description="Objevte náš rozsáhlý katalog kvalitních použitých motorů za výhodné ceny. Záruka funkčnosti a rychlé dodání."
        breadcrumbs={[
          {label: 'Domů', href: '/'},
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mb-12 max-w-4xl">
          <div className="text-lg text-gray-600">
            <p className="mb-4">
              Nabízíme široký výběr <strong>starých motorů</strong> pro všechny značky vozidel.
              Každý motor je důkladně kontrolován a testován před prodejem. Všechny naše motory jsou
            ...
            <p>
              ...
              Mercedes-Benz, Škoda, Ford a mnoha dalších. Použijte filtry níže pro nalezení motoru
              pro váš konkrétní model vozidla.
            </p>
          </div>
        </div>
