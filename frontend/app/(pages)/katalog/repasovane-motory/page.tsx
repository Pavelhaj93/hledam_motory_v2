  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <CategoryHero
        ...
        description="Objevte náš rozsáhlý katalog profesionálně repasovaných motorů s plnou zárukou kvality a spolehlivosti. Specializujeme se na všechny značky vozidel."
        breadcrumbs={[
          {label: 'Domů', href: '/'},
          {label: 'Katalog', href: '/katalog'},
          {label: 'Repasované motory'},
        ]}
      />
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mb-12 max-w-4xl">
          <div className="text-lg text-gray-600">
            ...
            <p>
              Specializujeme se na renovaci motorů značek BMW, Audi, Volkswagen, Mercedes-Benz,
              Škoda, Ford a mnoha dalších. Použijte filtry níže pro nalezení motoru pro váš
