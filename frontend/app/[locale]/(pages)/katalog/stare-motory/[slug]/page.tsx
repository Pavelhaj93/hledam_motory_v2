...
export default async function StaryMotorDetailPage({params}: Props) {
  ...
  const [{data: motor}, {data: settings}] = await Promise.all([
    sanityFetch({query: staryMotorQuery, params: {locale, slug}, stega: false}),
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="space-y-6">
          ...
          {motor.damageDescription && (
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-3">{t('damageDescription')}</h3>
          ...
          <div className="bg-red-50 rounded-lg p-6">
            ...
            <Link
              href={{pathname: '/kontakt', query: {motor: motor.name ?? ''}}}
