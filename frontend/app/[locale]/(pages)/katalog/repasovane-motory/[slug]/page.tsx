...
import {
  repasovanyMotorQuery,
  repasovaneMotoryPagesSlugs,
  settingsQuery,
...
export default async function RepasovanyMotorDetailPage({params}: Props) {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <BackButton fallbackHref="/katalog/repasovane-motory" label={t('backToCatalog')} />
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="space-y-6">
          ...
          <div className="border-t border-b py-6">
            ...
            {motor.warrantyPeriod && (
              <div className="flex items-center gap-2 text-sm text-gray-600 mt-3">
                <ShieldCheck className="h-4 w-4 text-green-600" />
                <span>
                  {t('warranty')}: {motor.warrantyPeriod}
                </span>
              </div>
            )}
          </div>
