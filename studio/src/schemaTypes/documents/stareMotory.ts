...
export const stareMotory = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      description: 'Celý název produktu, jak se zobrazí zákazníkům, např. „Motor BMW 2.0D 105 KW N47 – 120 000 km"',
    }),
    defineField({
      name: 'slug',
      title: 'Slug',
      description:
        'Formát: [značka]-[objem]-[palivo]-[kód-motoru]-[rok] → např. ford-2-2-tdci-p8fa-2018. Rok výroby odliší motory se stejným kódem. Pokud jsou dva se stejným rokem, přidej číslo: ford-2-2-tdci-p8fa-2018-2. Vynech výkon (KW) a emisní normu (EU4).',
      type: 'slug',
      validation: (Rule) => Rule.required(),
      options: {
        source: 'name',
